                        ...
                        <div class="ibox" style="height:700px">
                            <div class="ibox-body">
                                ...
                                <ul class="nav nav-tabs tabs-line">
                                    <li class="nav-item">
                                        <router-link :to="{name:'private.chat'}" class="nav-link active"><i class="ti-user"></i> Thành viên</router-link>
                                    </li>
                                    <li class="nav-item">
                                        <router-link :to="{name:'chat'}" class="nav-link"><i class="fa fa-users"></i> Nhóm</router-link>
                                    </li> 
                                </ul>
