      ...
      <ul>
        ...
        <li>
          <router-link :to="{ name: 'solution' }">
            ...
            <span class="hide-on-destop">Các giải pháp</span></router-link
          >
        </li>
        <li>
          <router-link :to="{ name: 'feedback' }">
            ...
            <span class="hide-on-destop">Các phản hổi</span></router-link
          >
        </li>
        <li v-if="check == true">
        ...
        <li v-else>
          <router-link :to="{ name: '' }" disabled>
            ...
            <span class="hide-on-destop" disabled>Trao đổi hỏi đáp</span></router-link
          >
        </li>
        <li>
          <router-link :to="{ name: 'payment' }">
            ...
            <span class="hide-on-destop">Thanh toán</span></router-link
          >
        </li>
      </ul>
    </nav>
