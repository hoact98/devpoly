                      ...
                      <div class="tab-content col-9">
                          ...
                          <div class="tab-pane fade show active" id="tab-9-1">
                            <form @submit.prevent="updateSolution" @keydown="form.onKeydown($event)" class="form-horizontal">
                              ...
                              <div class="form-group row">
                                  <label for="" class="col-sm-2 col-form-label">Link demo:</label>
                                  <div class="col-sm-10">
                              ...
                              <div class="form-group row">
                                  <label for="" class="col-sm-2 col-form-label">Link github:</label>
                                  <div class="col-sm-10">
                              ...
                              <div class="form-group row">
                                  <label for="" class="col-sm-2 col-form-label">Thử thách:</label>
                                  <div class="col-sm-10">
