    ...
    <div class="content mt-5">
        ...
        <div class="col-md-6">
          ...
          <div class="social-block">
            ...
            <p class="social-description">
                  Tham gia cùng các nhà phát triển khác để yêu cầu trợ giúp hoặc giúp đỡ người khác
            </p>
          ...
          <div class="social-block">
            ...
            <div>
              ...
              <p  class="social-description" style="">
               Xem hướng dẫn học và những câu chuyện của chúng tôi
              </p>
            </div>
          </div>
          </a>
        ...
        <div class="col-md-6">
          ...
          <div class="social-block">
            ...
            <div>
              ...
              <p  class="social-description" style="">
                Nhận thông tin cập nhật về DevPoly
              </p>
            </div>
          </div>
          </a>
        ...
        <div class="col-md-6">
          <div class="social-block">
            ...
            <div>
              <p class="social-label" style="">DevPoly Twitter</p>
              <p class="social-description" style="">
